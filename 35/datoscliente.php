...
?>
    ...
    <div id="izquierda">
        ...
        <form action="finalizar.php" method="POST" id="datoscliente">
            ...
            <input type="submit" value="Finalizar la compra" id="finalizacompra">
        </form>
    ...
    <div id="derecha">
        ...
        <p>Introduce tus datos</p>
        <form action="finalizarcliente.php" method="POST" id="datosclienteexistente">
